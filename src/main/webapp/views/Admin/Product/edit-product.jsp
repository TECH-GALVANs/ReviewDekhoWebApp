				...
				<form action="<%=request.getContextPath()%>/product" method="POST">
					...
					<div class="form-example-int">
						<div class="form-group">
							...
							<div class="nk-int-st">
								<input type="text" name="productId" hidden="true" value="<%=product.getProduct_id() %>">
								<input type="text" name="productName"
									class="form-control input-sm"
									placeholder="Enter Product name...." value="<%=product.getProduct_name() %>">
							</div>
						</div>
					</div>
					<br>
						...
						<div class="form-group">
							...
							<div class="nk-int-st">
								<input type="text" name="productDescription"
									class="form-control input-sm"
									placeholder="Enter Product description...." value="<%=product.getProduct_desc() %>">
							</div>
						</div>
					</div>
					<br>
						...
						<div class="form-group">
							...
							<div class="nk-int-st">
								<input type="text" name="productPrice"
									class="form-control input-sm"
									placeholder="Enter Product price...." value="<%=product.getProduct_price() %>">
							</div>
						</div>
					</div>
					<br>
